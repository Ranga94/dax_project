...
if __name__ == '__main__':
	create_table("pecten_dataset_dev","twitter_analytics_latest_price_tweets_copy","igenie-project")
	load_data_from_gcs("pecten_dataset_dev","twitter_analytics_latest_price_tweets_copy","gs://pecten_dataset_dev/twitter_analytics_latest_price_tweets.json")
	drop_table("pecten_dataset_dev","twitter_analytics_latest_price_tweets")
	copy_table("pecten_dataset_dev","twitter_analytics_latest_price_tweets_copy","twitter_analytics_latest_price_tweets","igenie-project")
	drop_table("pecten_dataset_dev","twitter_analytics_latest_price_tweets_copy")