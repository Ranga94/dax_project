...
if __name__ == '__main__':
	create_table("pecten_dataset_test","target_prices_copy","igenie-project")
	load_data_from_gcs("pecten_dataset_test","target_prices_copy","gs://pecten_dataset_test/target_prices.json")
	drop_table("pecten_dataset_test","target_prices")
	copy_table("pecten_dataset_test","target_prices_copy","target_prices","igenie-project")
	drop_table("pecten_dataset_test","target_prices_copy")