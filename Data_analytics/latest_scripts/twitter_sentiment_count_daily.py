...
def get_twitter_sentiment_count_daily(args):
    ...
    # Feature PECTEN-9
    backup_table_name = backup_table(args.google_key_path, common_parameters["BQ_DATASET"], 'twitter_sentiment_count_daily')
    ...
    try:
        before_insert(args.google_key_path,common_parameters["BQ_DATASET"],'twitter_sentiment_count_daily',
    ...
    try:
        ...
        rollback_object(args.google_key_path, 'table', common_parameters["BQ_DATASET"], None,
                        'twitter_sentiment_count_daily', backup_table_name)
        raise

    #Feature PECTEN-9
    try:
        after_insert(args.google_key_path,common_parameters["BQ_DATASET"],'twitter_sentiment_count_daily',
                     from_date,to_date,storage_client)
    except AssertionError as e:
