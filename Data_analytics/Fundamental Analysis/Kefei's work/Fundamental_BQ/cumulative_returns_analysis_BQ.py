...
def cumulative_returns_main(args):
    ...
    for constituent in constituent_list:
        print(constituent)
        #translate special german characters
...
##Develop scoring system for cumulative returns: if it is positive for all time periods, allocate 4, and so on. Higher the score, higher the rate of price growth.
