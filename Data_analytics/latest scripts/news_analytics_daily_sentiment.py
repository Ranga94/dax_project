...
def get_news_analytics_daily_sentiment_bq(args):
    ...
    # Feature PECTEN-9
    backup_table_name = backup_table(args.google_key_path, common_parameters["BQ_DATASET"], "news_analytics_daily_sentiment")
    ...
    try:
        before_insert(args.google_key_path,common_parameters["BQ_DATASET"],"news_analytics_daily_sentiment",from_date,to_date,storage_client)
    ...
    try:
        ...
        rollback_object(args.google_key_path, 'table', common_parameters["BQ_DATASET"], None,
                        'news_analytics_daily_sentiment', backup_table_name)
        raise

    #Feature PECTEN-9
    try:
        after_insert(args.google_key_path,common_parameters["BQ_DATASET"],'news_analytics_daily_sentiment',
